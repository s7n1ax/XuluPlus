...
extends Module {
    ...
    public VoidView() {
        super("VoidView", "views the void", Module.Category.Flex, true, false, false);
    }
    ...
    @Override
    public void onTick() {
        if (!(VoidView.fullNullCheck() || this.noEnd.getValue().booleanValue() && VoidView.mc.field_71439_g.field_71093_bK == 1 || !this.timer.passedMs(this.updates.getValue().intValue()))) {
    ...
    public void onRender3D(Render3DEvent event) {
        if (VoidView.fullNullCheck() || this.noEnd.getValue().booleanValue() && VoidView.mc.field_71439_g.field_71093_bK == 1) {
            return;
        }
    ...
    private List<BlockPos> findVoidHoles() {
        BlockPos playerPos = EntityUtil.getPlayerPos((EntityPlayer)VoidView.mc.field_71439_g);
    ...
    private boolean isVoid(BlockPos pos) {
        return (VoidView.mc.field_71441_e.func_180495_p(pos).func_177230_c() == Blocks.field_150350_a || this.air.getValue() == false && VoidView.mc.field_71441_e.func_180495_p(pos).func_177230_c() != Blocks.field_150357_h) && pos.func_177956_o() < 1 && pos.func_177956_o() >= 0;
    }
}
