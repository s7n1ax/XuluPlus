...
import me.alpha432.oyvey.features.modules.player.XCarryPhob;
...
extends Module {
    ...
    private final Setting<Boolean> shiftClick = this.register(new Setting<Boolean>("ShiftClick[CrashWhenSneak]", false));
    ...
    public AutoArmorPhob() {
        super("AutoArmor", "Equips armor and mends it too", Module.Category.COMBAT, true, false, false);
    }

    @SubscribeEvent
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        if (Keyboard.getEventKeyState() && !(AutoArmor.mc.field_71462_r instanceof OyVeyGui) && this.elytraBind.getValue().getKey() == Keyboard.getEventKey()) {
    ...
    public void onTick() {
        ...
        if (this.taskList.isEmpty()) {
            ...
            ItemStack chest;
            int slot4;
            if (this.mendingTakeOff.getValue().booleanValue() && InventoryUtil.holdingItem(ItemExpBottle.class) && AutoArmor.mc.field_71474_y.field_74313_G.func_151470_d() && (this.isSafe() || EntityUtilPhob.isSafe((Entity)AutoArmor.mc.field_71439_g, 1, false, true))) {
                ItemStack helm = AutoArmor.mc.field_71439_g.field_71069_bz.func_75139_a(5).func_75211_c();
                if (!helm.field_190928_g && DamageUtil.getRoundedDamage(helm) >= this.helmetThreshold.getValue()) {
                    this.takeOffSlot(5);
                }
                ItemStack chest2 = AutoArmor.mc.field_71439_g.field_71069_bz.func_75139_a(6).func_75211_c();
                if (!chest2.field_190928_g && DamageUtil.getRoundedDamage(chest2) >= this.chestThreshold.getValue()) {
                    this.takeOffSlot(6);
                }
                ItemStack legging2 = AutoArmor.mc.field_71439_g.field_71069_bz.func_75139_a(7).func_75211_c();
                if (!legging2.field_190928_g && DamageUtil.getRoundedDamage(legging2) >= this.legThreshold.getValue()) {
                    this.takeOffSlot(7);
                }
                ItemStack feet2 = AutoArmor.mc.field_71439_g.field_71069_bz.func_75139_a(8).func_75211_c();
                if (!feet2.field_190928_g && DamageUtil.getRoundedDamage(feet2) >= this.bootsThreshold.getValue()) {
                    this.takeOffSlot(8);
                }
                return;
            }
            ItemStack helm = AutoArmor.mc.field_71439_g.field_71069_bz.func_75139_a(5).func_75211_c();
            if (helm.func_77973_b() == Items.field_190931_a && (slot4 = InventoryUtil.findArmorSlot(EntityEquipmentSlot.HEAD, this.curse.getValue(), XCarryPhob.getInstance().isOn())) != -1) {
            ...
            if ((chest = AutoArmor.mc.field_71439_g.field_71069_bz.func_75139_a(6).func_75211_c()).func_77973_b() == Items.field_190931_a) {
                if (this.taskList.isEmpty()) {
                    if (this.elytraOn && this.elytraTimer.passedMs(500L)) {
                        int elytraSlot = InventoryUtil.findItemInventorySlot(Items.field_185160_cR, false, XCarryPhob.getInstance().isOn());
                        if (elytraSlot != -1) {
                    ...
                    } else if (!this.elytraOn && (slot3 = InventoryUtil.findArmorSlot(EntityEquipmentSlot.CHEST, this.curse.getValue(), XCarryPhob.getInstance().isOn())) != -1) {
                        this.getSlotOn(6, slot3);
                    }
                }
            } else if (this.elytraOn && chest.func_77973_b() != Items.field_185160_cR && this.elytraTimer.passedMs(500L)) {
                if (this.taskList.isEmpty()) {
                    slot3 = InventoryUtil.findItemInventorySlot(Items.field_185160_cR, false, XCarryPhob.getInstance().isOn());
                    if (slot3 != -1) {
                ...
                slot3 = InventoryUtil.findItemInventorySlot((Item)Items.field_151163_ad, false, XCarryPhob.getInstance().isOn());
                if (slot3 == -1 && (slot3 = InventoryUtil.findItemInventorySlot((Item)Items.field_151030_Z, false, XCarryPhob.getInstance().isOn())) == -1 && (slot3 = InventoryUtil.findItemInventorySlot((Item)Items.field_151171_ah, false, XCarryPhob.getInstance().isOn())) == -1 && (slot3 = InventoryUtil.findItemInventorySlot((Item)Items.field_151023_V, false, XCarryPhob.getInstance().isOn())) == -1) {
                    slot3 = InventoryUtil.findItemInventorySlot((Item)Items.field_151027_R, false, XCarryPhob.getInstance().isOn());
                }
                if (slot3 != -1) {
                    this.taskList.add(new InventoryUtil.Task(slot3));
                    this.taskList.add(new InventoryUtil.Task(6));
            ...
            if (AutoArmor.mc.field_71439_g.field_71069_bz.func_75139_a(7).func_75211_c().func_77973_b() == Items.field_190931_a && (slot2 = InventoryUtil.findArmorSlot(EntityEquipmentSlot.LEGS, this.curse.getValue(), XCarryPhob.getInstance().isOn())) != -1) {
                this.getSlotOn(7, slot2);
            }
            if (AutoArmor.mc.field_71439_g.field_71069_bz.func_75139_a(8).func_75211_c().func_77973_b() == Items.field_190931_a && (slot = InventoryUtil.findArmorSlot(EntityEquipmentSlot.FEET, this.curse.getValue(), XCarryPhob.getInstance().isOn())) != -1) {
    ...
    private void takeOffSlot(int slot) {
        if (this.taskList.isEmpty()) {
            int target = -1;
            for (int i : InventoryUtil.findEmptySlots(XCarryPhob.getInstance().isOn())) {
    ...
    private boolean isSafe() {
        EntityPlayer closest = EntityUtilPhob.getClosestEnemy(this.closestEnemy.getValue().intValue());
        if (closest == null) {
            return true;
        }
