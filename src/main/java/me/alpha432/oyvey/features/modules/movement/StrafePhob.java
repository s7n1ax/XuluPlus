...
extends Module {
    ...
    public static double getBaseMoveSpeed() {
        ...
        if (StrafePhob.mc.field_71439_g.func_70644_a(MobEffects.field_76424_c)) {
            int amplifier = Objects.requireNonNull(StrafePhob.mc.field_71439_g.func_70660_b(MobEffects.field_76424_c)).func_76458_c();
    ...
    public void onEnable() {
        if (!StrafePhob.mc.field_71439_g.field_70122_E) {
    ...
    public void onUpdateWalkingPlayer(UpdateWalkingPlayerEvent event) {
        if (event.getStage() == 0) {
            this.lastDist = Math.sqrt((StrafePhob.mc.field_71439_g.field_70165_t - StrafePhob.mc.field_71439_g.field_70169_q) * (StrafePhob.mc.field_71439_g.field_70165_t - StrafePhob.mc.field_71439_g.field_70169_q) + (StrafePhob.mc.field_71439_g.field_70161_v - StrafePhob.mc.field_71439_g.field_70166_s) * (StrafePhob.mc.field_71439_g.field_70161_v - StrafePhob.mc.field_71439_g.field_70166_s));
        }
    }
    ...
    public void onMove(MoveEvent event) {
        ...
        if (this.mode.getValue() == Mode.NCP) {
            ...
            float moveForward = StrafePhob.mc.field_71439_g.field_71158_b.field_192832_b;
            float moveStrafePhob = StrafePhob.mc.field_71439_g.field_71158_b.field_78902_a;
            float rotationYaw = StrafePhob.mc.field_71439_g.field_70177_z;
            if (this.step.getValue() == 1) {
                StrafePhob.mc.field_71439_g.field_70138_W = 0.6f;
            }
            if (this.limiter2.getValue().booleanValue() && StrafePhob.mc.field_71439_g.field_70122_E && OyVey.speedManager.getSpeedKpH() < (double)this.speedLimit2.getValue().floatValue()) {
                this.stage = 2;
            }
            if (this.limiter.getValue().booleanValue() && StrafePhob.round(StrafePhob.mc.field_71439_g.field_70163_u - (double)((int)StrafePhob.mc.field_71439_g.field_70163_u), 3) == StrafePhob.round((double)this.setGroundLimit.getValue().intValue() / 1000.0, 3) && (!this.setGroundNoLag.getValue().booleanValue() || EntityUtilPhob.isEntityMoving((Entity)StrafePhob.mc.field_71439_g))) {
                if (this.setNull.getValue().booleanValue()) {
                    StrafePhob.mc.field_71439_g.field_70181_x = 0.0;
                } else {
                    StrafePhob.mc.field_71439_g.field_70181_x -= (double)this.groundFactor.getValue().intValue() / 100.0;
                    event.setY(event.getY() - (double)this.groundFactor.getValue().intValue() / 100.0);
                    if (this.setPos.getValue().booleanValue()) {
                        StrafePhob.mc.field_71439_g.field_70163_u -= (double)this.groundFactor.getValue().intValue() / 100.0;
                    }
                }
            }
            if (this.stage == 1 && EntityUtilPhob.isMoving()) {
                ...
                this.stage = 3;
                StrafePhob.mc.field_71439_g.field_70181_x = (double)this.yOffset.getValue().intValue() / 1000.0;
                ...
                if (StrafePhob.mc.field_71441_e.func_184144_a((Entity)StrafePhob.mc.field_71439_g, StrafePhob.mc.field_71439_g.func_174813_aQ().func_72317_d(0.0, StrafePhob.mc.field_71439_g.field_70181_x, 0.0)).size() > 0 || StrafePhob.mc.field_71439_g.field_70124_G && this.stage > 0) {
                    this.stage = this.bhop2.getValue() != false && OyVey.speedManager.getSpeedKpH() >= (double)this.speedLimit.getValue().floatValue() ? 0 : (StrafePhob.mc.field_71439_g.field_191988_bg != 0.0f || StrafePhob.mc.field_71439_g.field_70702_br != 0.0f ? 1 : 0);
                }
    ...
    private void doNCP(MoveEvent event) {
        if (!this.limiter.getValue().booleanValue() && StrafePhob.mc.field_71439_g.field_70122_E) {
            this.stage = 2;
        }
        switch (this.stage) {
            case 0: {
            ...
            case 2: {
                ...
                if (StrafePhob.mc.field_71439_g.field_191988_bg == 0.0f && StrafePhob.mc.field_71439_g.field_70702_br == 0.0f || !StrafePhob.mc.field_71439_g.field_70122_E) break;
                if (StrafePhob.mc.field_71439_g.func_70644_a(MobEffects.field_76430_j)) {
                    motionY += (double)((float)(Objects.requireNonNull(StrafePhob.mc.field_71439_g.func_70660_b(MobEffects.field_76430_j)).func_76458_c() + 1) * 0.1f);
                }
                StrafePhob.mc.field_71439_g.field_70181_x = motionY;
                event.setY(StrafePhob.mc.field_71439_g.field_70181_x);
        ...
        this.moveSpeed = Math.max(this.moveSpeed, StrafePhob.getBaseMoveSpeed());
        double forward = StrafePhob.mc.field_71439_g.field_71158_b.field_192832_b;
        double strafe = StrafePhob.mc.field_71439_g.field_71158_b.field_78902_a;
        double yaw = StrafePhob.mc.field_71439_g.field_70177_z;
    ...
    private float getMultiplier() {
        ...
        if (this.potion.getValue().booleanValue() && StrafePhob.mc.field_71439_g.func_70644_a(MobEffects.field_76424_c)) {
            int amplifier = Objects.requireNonNull(StrafePhob.mc.field_71439_g.func_70660_b(MobEffects.field_76424_c)).func_76458_c() + 1;
