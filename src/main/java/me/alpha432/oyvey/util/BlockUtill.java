...
implements Util {
    ...
    public static boolean canBeClicked(BlockPos pos) {
        return BlockUtill.getBlock(pos).func_176209_a(BlockUtill.getState(pos), false);
    }

    private static Block getBlock(BlockPos pos) {
        return BlockUtill.getState(pos).func_177230_c();
    }
    ...
    public static boolean GetState() {
        return _currBlock != null && BlockUtill.IsDoneBreaking(BlockUtill.mc.field_71441_e.func_180495_p(_currBlock));
    }
    ...
    public static boolean Update(float range, boolean rayTrace) {
        ...
        IBlockState state = BlockUtill.mc.field_71441_e.func_180495_p(_currBlock);
        if (!BlockUtill.IsDoneBreaking(state) && !(BlockUtill.mc.field_71439_g.func_174818_b(_currBlock) > Math.pow(range, range))) {
            RayTraceResult result;
            BlockUtill.mc.field_71439_g.func_184609_a(EnumHand.MAIN_HAND);
            EnumFacing facing = EnumFacing.UP;
            if (rayTrace && (result = BlockUtill.mc.field_71441_e.func_72933_a(new Vec3d(BlockUtill.mc.field_71439_g.field_70165_t, BlockUtill.mc.field_71439_g.field_70163_u + (double)BlockUtill.mc.field_71439_g.func_70047_e(), BlockUtill.mc.field_71439_g.field_70161_v), new Vec3d((double)_currBlock.func_177958_n() + 0.5, (double)_currBlock.func_177956_o() - 0.5, (double)_currBlock.func_177952_p() + 0.5))) != null && result.field_178784_b != null) {
                facing = result.field_178784_b;
            }
            if (!_started) {
                _started = true;
                BlockUtill.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketPlayerDigging(CPacketPlayerDigging.Action.START_DESTROY_BLOCK, _currBlock, facing));
                BlockUtill.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketPlayerDigging(CPacketPlayerDigging.Action.START_DESTROY_BLOCK, _currBlock, facing));
            } else {
                BlockUtill.mc.field_71442_b.func_180512_c(_currBlock, facing);
            }
            return true;
        }
        _currBlock = null;
