...
implements Util {
    ...
    public static final List<Block> unSafeBlocks = Arrays.asList(new Block[]{Blocks.field_150343_Z, Blocks.field_150357_h, Blocks.field_150477_bB, Blocks.field_150467_bQ});
    ...
    public static void rightClickBlockLegit(BlockPos pos, float range, boolean rotate, EnumHand hand, AtomicDouble Yaw2, AtomicDouble Pitch, AtomicBoolean rotating) {
    ...
    public static boolean rayTracePlaceCheckCa(BlockPos pos, boolean shouldCheck) {
        return BlockUtil.rayTracePlaceCheckCa(pos, shouldCheck, 1.0f);
    }

    public static boolean rayTracePlaceCheckCa(BlockPos pos) {
        return BlockUtil.rayTracePlaceCheckCa(pos, true);
    }
    ...
    public static List<Vec3d> getUnsafeBlocks(Entity entity, int height, boolean floor) {
        return BlockUtil.getUnsafeBlocksFromVec3d(entity.func_174791_d(), height, floor);
    }
    ...
    public static List<Vec3d> getUnsafeBlocksFromVec3d(Vec3d pos, int height, boolean floor) {
        ...
        for (Vec3d vector : BlockUtil.getOffsets(height, floor)) {
            ...
            Block block = Minecraftable.mc.field_71441_e.func_180495_p(targetPos).func_177230_c();
    ...
    public static boolean canPlaceCrystalRealth(BlockPos pos, boolean checkSecond) {
        Chunk chunk = BlockUtil.mc.field_71441_e.func_175726_f(pos);
        ...
        return BlockUtil.mc.field_71441_e.func_175647_a(Entity.class, new AxisAlignedBB((double)boost.func_177958_n(), (double)boost.func_177956_o(), (double)boost.func_177952_p(), (double)(boost.func_177958_n() + 1), (double)(boost.func_177956_o() + (checkSecond ? 2 : 1)), (double)(boost.func_177952_p() + 1)), e -> !(e instanceof EntityEnderCrystal)).isEmpty();
    }
    ...
    public static void placeBlockRealth(BlockPos pos) {
        for (EnumFacing side : EnumFacing.field_82609_l) {
            ...
            IBlockState neighborState = BlockUtil.mc.field_71441_e.func_180495_p(neighbor);
            if (!neighborState.func_177230_c().func_176209_a(neighborState, false)) continue;
            boolean sneak = !BlockUtil.mc.field_71439_g.func_70093_af() && neighborState.func_177230_c().func_180639_a((World)BlockUtil.mc.field_71441_e, pos, BlockUtil.mc.field_71441_e.func_180495_p(pos), (EntityPlayer)BlockUtil.mc.field_71439_g, EnumHand.MAIN_HAND, side, 0.5f, 0.5f, 0.5f);
            boolean bl = sneak;
            if (sneak) {
                mc.func_147114_u().func_147297_a((Packet)new CPacketEntityAction((Entity)BlockUtil.mc.field_71439_g, CPacketEntityAction.Action.START_SNEAKING));
            }
            ...
            if (!sneak) continue;
            mc.func_147114_u().func_147297_a((Packet)new CPacketEntityAction((Entity)BlockUtil.mc.field_71439_g, CPacketEntityAction.Action.STOP_SNEAKING));
        }
    }
}
